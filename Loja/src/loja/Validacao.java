...
public class Validacao {
    public static void existeDisciplina(String nome, ListaCliente listc) throws ExClienteInexistente{
        for(Cliente c: listc){
    ...
    public static void existeDisciplina(String cod, ListaProduto listp) throws ExProdutoInexistente{
        for(Produto p: listp){
